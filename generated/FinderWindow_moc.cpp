...
static const char qt_meta_stringdata_FinderWindow[] = {
    "FinderWindow\0\0bool\0Find()\0"
};
...
const QMetaObjectExtraData FinderWindow::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject FinderWindow::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_FinderWindow,
      qt_meta_data_FinderWindow, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &FinderWindow::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_FinderWindow))
        return static_cast<void*>(const_cast< FinderWindow*>(this));
